            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- Population field -->
                        <div class="row mb-3">
                            <label for="population" class="col-md-4 col-form-label text-md-end">{{ __('Population') }}</label>

                            <div class="col-md-6">
                                <input id="population" type="text" class="form-control @error('population') is-invalid @enderror" name="population" value="{{ old('population') }}" required autocomplete="population">
