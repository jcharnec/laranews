                            ...
                            @auth
                                <li class="nav-item mr-2">
                                    <a class="nav-link {{$pagina == 'home'? 'active':''}}" 
                                        href="{{route('home')}}">Mis noticias</a>
                                </li>
                                <li class="nav-item mr-2">
                                    <a class="nav-link {{$pagina =='noticias.create'? 'active':''}}" 
                                        href="{{action([App\Http\Controllers\NoticiaController::class, 'create'])}}">Nueva noticia</a>
                                </li>
                                @if(Auth::user()->hasRole('administrador'))
                                    <li class="nav-item mr-2">
                                        <a class="nav-link {{$pagina =='admin.deleted.bikes'? 'active':''}}"
                                            href="{{route('admin.deleted.bikes')}}">Noticias borradas</a>
                                    </li>
